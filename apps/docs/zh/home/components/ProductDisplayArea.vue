...
<template>
  <div class="outer-container flex flex-col gap-y-120px">
    <h2 class="reviews-title max-w-[1200px] mx-auto">
      产品展示
    </h2>
...
.chat-project-img {
  ...
  position: relative;
  z-index: 2;
  border: 1px solid rgba(94, 184, 255, calc(var(--self-shadow-shade) / 100 * 0.2));
...
@keyframes breathe {
  ...
  50% {
    transform: translateX(-50%) scale(calc(1.1 + var(--self-shadow-shade) / 100 * 0.2));
