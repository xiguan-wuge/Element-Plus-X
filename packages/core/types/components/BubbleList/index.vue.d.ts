...
import { TypewriterInstance } from "../Typewriter/types.d.ts";
import { BubbleListEmits, BubbleListProps } from "./types.d.ts";
      ...
      Pick<
        Partial<{}> &
          Omit<
            {
              readonly onComplete?:
                | ((instance: TypewriterInstance, index: number) => any)
                | undefined;
